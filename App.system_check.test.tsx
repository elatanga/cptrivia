...
describe('SYSTEM: Critical Flow Automations', () => {
  ...
  test('transport bootstrap status failure shows fatal status screen and keeps bootstrap locked', async () => {
    ...
    expect(screen.queryByRole('button', { name: /Initialize Studio/i })).not.toBeInTheDocument();
  });
});
